...
/**
 * A class representing a INDI Switch ViewProperty. <p> It implements a listener
...
public class INDISwitchProperty extends INDIProperty {
  ...
  /**
   * The current Rule for this Switch ViewProperty.
   */
   ...
   * the ViewProperty.
   * @param device The <code>INDIDevice</code> to which this ViewProperty belongs.
  ...
  protected INDISwitchProperty(Element xml, INDIDevice device) throws IllegalArgumentException {
    ...
    if (rul.compareTo("OneOfMany") == 0) {
      ...
      throw new IllegalArgumentException("Illegal Rule for the Switch ViewProperty");
    }
    ...
    if (!checkCorrectValues()) {
      if (getSelectedCount() != 0) {  // Sometimes de CONFIG_PROCESS is not correct at the beginning. skip
        throw new IllegalArgumentException("Illegal initial value for Switch ViewProperty");
      }
  ...
  /**
   * Gets the current Rule for this Switch ViewProperty
   *
   * @return the current Rule for this Switch ViewProperty
   */
  ...
  /**
   * Sets the Permission of this ViewProperty. If set to Write Only it defaults to
   ...
   *
   * @return <code>true</code> if the values of the Elements of this ViewProperty
  ...
  /**
   * Gets the opening XML Element &lt;newSwitchVector&gt; for this ViewProperty.
   *
   * @return the opening XML Element &lt;newSwitchVector&gt; for this ViewProperty.
   */
  @Override
  ...
  /**
   * Gets the closing XML Element &lt;/newSwitchVector&gt; for this ViewProperty.
   *
   * @return the closing XML Element &lt;/newSwitchVector&gt; for this ViewProperty.
   */
  @Override
   ...
   * @return The Element of this ViewProperty with the given <code>name</code>.
