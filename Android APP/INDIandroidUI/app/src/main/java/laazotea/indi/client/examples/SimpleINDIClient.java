...
public class SimpleINDIClient implements INDIServerConnectionListener, INDIDeviceListener, INDIPropertyListener {
  ...
  public void newProperty(INDIDevice device, INDIProperty property) {
    // We just simply listen to this ViewProperty
    System.out.println("New ViewProperty (" + property.getName() + ") added to device " + device.getName());
  ...
  public void removeProperty(INDIDevice device, INDIProperty property) {
    ...
    System.out.println("ViewProperty (" + property.getName() + ") removed from device " + device.getName());
  ...
  public void propertyChanged(INDIProperty property) {
    System.out.println("ViewProperty Changed: " + property.getNameStateAndValuesAsString());
  }
