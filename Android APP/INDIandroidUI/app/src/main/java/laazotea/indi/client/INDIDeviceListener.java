...
public interface INDIDeviceListener {
  ...
  /**
   * Called when a new ViewProperty is added to the Device.
   * @param device The Device on which the ViewProperty has been addded.
   * @param property The ViewProperty that has been added.
   */
  public abstract void newProperty(INDIDevice device, INDIProperty property);

  /**
   * Called when a ViewProperty is removed from a Device.
   * @param device The Device to which the ViewProperty has been removed.
   * @param property The ViewProperty that has been removed.
   */
