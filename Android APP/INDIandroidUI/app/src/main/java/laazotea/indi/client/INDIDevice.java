...
public class INDIDevice {
  ...
  /**
   * Sends the appropriate message to the Server to establish a particular BLOB
   * policy (BLOBEnable) for the Device and a particular ViewProperty.
   *
   * @param enable The BLOB policy.
   * @param property The ViewProperty of the Device to listen to.
   * @throws IOException if there is some problem sending the message.
   */
  ...
  /**
   * Processes a XML &lt;delProperty&gt;. It removes the appropriate ViewProperty
  ...
  /**
   * This function waits until a ViewProperty with a
   ...
   *
   * @param name The name of the ViewProperty to wait for.
   * @return The ViewProperty once it exists in this device.
   */
   ...
   *
   * @param name The name of the ViewProperty to wait for.
   * @param maxWait Maximum number of seconds to wait for the ViewProperty
   * @return The ViewProperty once it exists in this Device or
  ...
  /**
   * Processes a XML &lt;setXXXVector&gt;. It updates the appropiate ViewProperty.
   *
   * @param xml the XML message to be processed.
   */
  ...
  /**
   * Adds a ViewProperty to the properties list and updates the BLOB count if
   * necessary.
   *
   * @param property
   */
  ...
  /**
   * Removes a ViewProperty from the properties list and updates the BLOB count if
   * necessary.
   *
   * @param property
   */
  ...
  /**
   * Gets a ViewProperty by its name.
   *
   * @param name the name of the ViewProperty to be retrieved.
   * @return the ViewProperty with the
   * <code>name</code> or
   * <code>null</code> if there is no ViewProperty with that name.
   */
  ...
  /**
   * A convenience method to get the Element of a ViewProperty by specifiying their
   * names.
   *
   * @param propertyName the name of the ViewProperty.
