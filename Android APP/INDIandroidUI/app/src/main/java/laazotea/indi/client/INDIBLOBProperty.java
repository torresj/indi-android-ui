...
/**
 * A class representing a INDI BLOB ViewProperty.<p> It implements a listener
...
public class INDIBLOBProperty extends INDIProperty {
  ...
  /**
   * Gets the opening XML Element &lt;newBLOBVector&gt; for this ViewProperty.
   *
   * @return the opening XML Element &lt;newBLOBVector&gt; for this ViewProperty.
   */
  @Override
  ...
  /**
   * Gets the closing XML Element &lt;/newBLOBVector&gt; for this ViewProperty.
   *
   * @return the closing XML Element &lt;/newBLOBVector&gt; for this ViewProperty.
   */
  @Override
