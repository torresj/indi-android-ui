...
/**
 * A class representing a INDI Text ViewProperty.<p> It implements a listener
...
public class INDITextProperty extends INDIProperty {
  ...
  /**
   * Gets the opening XML Element &lt;newTextVector&gt; for this ViewProperty.
   *
   * @return the opening XML Element &lt;newTextVector&gt; for this ViewProperty.
   */
  @Override
  ...
  /**
   * Gets the closing XML Element &lt;/newTextVector&gt; for this ViewProperty.
   *
   * @return the closing XML Element &lt;/newTextVector&gt; for this ViewProperty.
   */
  @Override
