...
/**
 * A class representing a INDI ViewProperty. The subclasses
...
public abstract class INDIProperty {
  ...
  /**
   * The group to which this ViewProperty might be assigned
   */
  private String group;
  /**
   * The current state of this ViewProperty
   */
  private PropertyStates state;
  /**
   * The permission of this ViewProperty
   */
  private PropertyPermissions permission;
  /**
   * The timeout of this ViewProperty
   */
  private int timeout;
  /**
   * A list of elements for this ViewProperty
   */
  private LinkedHashMap<String, INDIElement> elements;
  /**
   * The list of listeners of this ViewProperty
   */
   ...
   * <code>&lt;defXXXVector&gt;</code> describing the ViewProperty.
   * @param device The
   * <code>INDIDevice</code> to which this ViewProperty belongs.
   * @throws IllegalArgumentException if the XML ViewProperty is not well formed
   * (does not contain a
  ...
  protected INDIProperty(Element xml, INDIDevice device) throws IllegalArgumentException {
    ...
    if (name.compareTo("") == 0) {  // If no name, ignore
      throw new IllegalArgumentException("No name for the ViewProperty");
    }
...
//          System.out.println(child + " - " + name + " - " + iel);
   ...
   *
   * @param newState The new state for this ViewProperty in form of a String:
   * <code>Idle</code>,
   * <code>Ok</code>,
   * <code>Busy</code> or
   * <code>Alert</code>.
  ...
  /**
   * Sets the current timeout for this ViewProperty
   *
  ...
  private void setTimeout(String newTimeout) throws IllegalArgumentException {
    try {
      ...
      if (timeout < 0) {
        throw new IllegalArgumentException("Illegal timeout for the ViewProperty");
      }
  ...
  /**
   * Gets the Device that owns this ViewProperty.
   *
   * @return the Device that owns this ViewProperty
   */
  ...
  /**
   * Gets the timeout for this ViewProperty.
   *
   * @return the timeout for this ViewProperty.
   */
  ...
  /**
   * Gets the label for this ViewProperty.
   *
   * @return the label for this ViewProperty.
   */
  ...
  /**
   * Gets the name of this ViewProperty
   *
   * @return the name of this ViewProperty
   */
  ...
  /**
   * Gets the number of Elements in this ViewProperty
   *
   * @return the number of Elements in this ViewProperty.
   */
  ...
  /**
   * Gets the Permission of this ViewProperty.
   *
   * @return the Permission of this ViewProperty.
   */
  ...
  /**
   * Gets the State of this ViewProperty.
   *
   * @return the State of this ViewProperty.
   */
   ...
   *
   * @param timeout the new timeout for this ViewProperty.
   */
  ...
  /**
   * Sets the State of this ViewProperty. The listeners are notified of this change.
   *
   * @param state the new State of this ViewProperty.
   */
  ...
  /**
   * Sets the Permission of this ViewProperty.
   *
   * @param permission the new Permission for this ViewProperty.
   */
  ...
  /**
   * Adds a new Element to this ViewProperty.
   *
  ...
  /**
   * Gets a particular Element of this ViewProperty by its name.
   *
   * @param name The name of the Element to be returned
   * @return The Element of this ViewProperty with the given
   * <code>name</code>.
  ...
  /**
   * Gets a
   * <code>ArrayList</code> with all the Elements of this ViewProperty.
   *
   * @return the
   * <code>ArrayList</code> of Elements belonging to this ViewProperty.
   */
  ...
  /**
   * Tests and changes the desired values of the the Elements of this ViewProperty.
   ...
   * if the ViewProperty is Read Only.
  ...
  /**
   * Adds a new listener to this ViewProperty.
   *
  ...
  /**
   * Removes a listener from this ViewProperty.
   *
  ...
  /**
   * Notifies all the listeners about the changes in the ViewProperty.
   */
  ...
  /**
   * Gets the opening XML Element &lt;newXXXVector&gt; for this ViewProperty.
   *
   * @return the opening XML Element &lt;newXXXVector&gt; for this ViewProperty.
   */
  protected abstract String getXMLPropertyChangeInit();

  /**
   * Gets the closing XML Element &lt;/newXXXVector&gt; for this ViewProperty.
   *
   * @return the closing XML Element &lt;/newXXXVector&gt; for this ViewProperty.
   */
   ...
   * ViewProperty. The panel is registered as a listener of this ViewProperty. Please
   ...
   * property.
   *
   * @return A UI component that handles this ViewProperty.
   */
  public abstract INDIPropertyListener getDefaultUIComponent() throws INDIException;

  /**
   * Gets the names of the Elements of this ViewProperty.
   *
   * @return the names of the Elements of this ViewProperty.
   */
  ...
  /**
   * Returns a String with the name of the ViewProperty, its state and its elements
   * and values.
   *
  ...
  /**
   * Gets the values of the ViewProperty as a String.
   *
   * @return A String representation of the value of the ViewProperty.
   */
