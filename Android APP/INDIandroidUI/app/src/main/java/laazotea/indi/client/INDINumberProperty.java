...
/**
 * A class representing a INDI Number ViewProperty.<p> It implements a listener
...
public class INDINumberProperty extends INDIProperty {
  ...
  /**
   * Gets the opening XML Element &lt;newNumberVector&gt; for this ViewProperty.
   *
   * @return the opening XML Element &lt;newNumberVector&gt; for this ViewProperty.
   */
  @Override
  ...
  /**
   * Gets the closing XML Element &lt;/newNumberVector&gt; for this ViewProperty.
   *
   * @return the closing XML Element &lt;/newNumberVector&gt; for this ViewProperty.
   */
  @Override
