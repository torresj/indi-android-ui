...
//        socket.close();
  ...
  /**
   * Sends the appropriate message to the INDI Server to be notified about a
   * particular ViewProperty of a particular Device of the Server.
   *
   * @param device the Device name of whose property is asked for.
   * @param propertyName the ViewProperty name that is asked for.
   * @throws IOException if there is some problem with the Connection.
   */
  ...
  /**
   * A convenience method to get the ViewProperty of a Device by specifiying their
   * names.
   *
   * @param deviceName the name of the Device.
   * @param propertyName the name of the ViewProperty.
   * @return the ViewProperty with
  ...
  /**
   * A convenience method to get the Element of a ViewProperty of a Device by
   * specifiying their names.
   *
   * @param deviceName the name of the ViewProperty.
   * @param propertyName the name of the Element.
   * @param elementName the name of the Element.
   * @return the Element with a
   * <code>elementName</code> as a name of a ViewProperty with
   * <code>propertyName</code> as name of the device with
   * <code>deviceName</code> as name.
   */
